...
public:
    ...
    void drawBuilding(const cBuilding& building, SDL_Rect destination, float zoomFactor, const cUnitSelection* unitSelection = nullptr, const cPlayer* player = nullptr);
    void drawVehicle(const cVehicle& vehicle, SDL_Rect destination, float zoomFactor, const cMapView& map, const cUnitSelection* unitSelection = nullptr, const cPlayer* player = nullptr);
