...
/*
 * TODO: AI needs some sort of 'influence' map, indicating a logical distance from the base
 * Path planners are very good with using this maps
 */
...
{
    // TODO: Djkstra can easily solve any sort of surveyor problems
	cPosition bestPosition (-1, -1);
	float minValue = 0;
	const cMap& map = *client.getModel().getMap();
